...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _2222: (x0,x1,x2) => x0.open(x1,x2),
      _2223: x0 => x0.abort(),
      _2224: x0 => x0.getAllResponseHeaders(),
      _2225: (x0,x1) => x0.item(x1),
      ...
      _2234: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._2234(f,arguments.length,x0,x1,x2) }),
      _2235: (x0,x1) => x0.forEach(x1),
      _2236: x0 => x0.getReader(),
      _2237: x0 => x0.cancel(),
      _2238: x0 => x0.read(),
      _2239: x0 => x0.trustedTypes,
      _2240: (x0,x1) => { x0.src = x1 },
      _2241: (x0,x1) => x0.createScriptURL(x1),
      _2242: x0 => x0.nonce,
      _2243: (x0,x1) => x0.debug(x1),
      _2244: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2244(f,arguments.length,x0) }),
      _2245: x0 => ({createScriptURL: x0}),
      _2246: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _2247: (x0,x1) => x0.querySelectorAll(x1),
      _2248: (x0,x1) => x0.createImageBitmap(x1),
      _2430: (x0,x1) => { x0.fillColor = x1 },
      _2469: x0 => x0.random(),
      _2470: (x0,x1) => x0.getRandomValues(x1),
      _2471: () => globalThis.crypto,
      _2472: () => globalThis.Math,
      _2476: (x0,x1,x2) => x0.toDataURL(x1,x2),
      _2479: Function.prototype.call.bind(Number.prototype.toString),
      _2480: Function.prototype.call.bind(BigInt.prototype.toString),
      _2481: Function.prototype.call.bind(Number.prototype.toString),
      _2482: (d, digits) => d.toFixed(digits),
      _2491: () => globalThis.document,
      _2492: () => globalThis.window,
      _2497: (x0,x1) => { x0.height = x1 },
      _2499: (x0,x1) => { x0.width = x1 },
      _2502: x0 => x0.head,
      _2503: x0 => x0.classList,
      _2507: (x0,x1) => { x0.innerText = x1 },
      _2508: x0 => x0.style,
      _2510: x0 => x0.sheet,
      _2511: x0 => x0.src,
      _2512: (x0,x1) => { x0.src = x1 },
      _2513: x0 => x0.naturalWidth,
      _2514: x0 => x0.naturalHeight,
      _2521: x0 => x0.offsetX,
      _2522: x0 => x0.offsetY,
      _2523: x0 => x0.button,
      _2530: x0 => x0.status,
      _2531: (x0,x1) => { x0.responseType = x1 },
      _2533: x0 => x0.response,
      _2610: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _2611: f => finalizeWrapper(f, function() { return dartInstance.exports._2611(f,arguments.length) }),
      _2649: x0 => x0.readyState,
      _2651: (x0,x1) => { x0.timeout = x1 },
      _2653: (x0,x1) => { x0.withCredentials = x1 },
      _2654: x0 => x0.upload,
      _2655: x0 => x0.responseURL,
      _2656: x0 => x0.status,
      _2657: x0 => x0.statusText,
      _2659: (x0,x1) => { x0.responseType = x1 },
      _2660: x0 => x0.response,
      _2672: x0 => x0.loaded,
      _2673: x0 => x0.total,
      _2720: (x0,x1) => { x0.draggable = x1 },
      _2736: x0 => x0.style,
      _2749: (x0,x1) => { x0.oncancel = x1 },
      _2755: (x0,x1) => { x0.onchange = x1 },
      _2795: (x0,x1) => { x0.onerror = x1 },
      _2811: (x0,x1) => { x0.onload = x1 },
      _2935: (x0,x1) => { x0.nonce = x1 },
      _2989: x0 => x0.content,
      _3095: (x0,x1) => { x0.download = x1 },
      _3120: (x0,x1) => { x0.href = x1 },
      _3168: (x0,x1) => { x0.src = x1 },
      _3662: (x0,x1) => { x0.accept = x1 },
      _3676: x0 => x0.files,
      _3702: (x0,x1) => { x0.multiple = x1 },
      _3720: (x0,x1) => { x0.type = x1 },
      _3969: x0 => x0.src,
      _3970: (x0,x1) => { x0.src = x1 },
      _3972: (x0,x1) => { x0.type = x1 },
      _3976: (x0,x1) => { x0.async = x1 },
      _3978: (x0,x1) => { x0.defer = x1 },
      _3990: (x0,x1) => { x0.charset = x1 },
      _4015: (x0,x1) => { x0.width = x1 },
      _4017: (x0,x1) => { x0.height = x1 },
      _4437: () => globalThis.window,
      _4477: x0 => x0.document,
      _4480: x0 => x0.location,
      _4499: x0 => x0.navigator,
      _4754: x0 => x0.isSecureContext,
      _4757: x0 => x0.crypto,
      _4761: x0 => x0.trustedTypes,
      _4762: x0 => x0.sessionStorage,
      _4763: x0 => x0.localStorage,
      _4771: x0 => x0.href,
      _4822: x0 => x0.message,
      _4865: x0 => x0.clipboard,
      _4867: x0 => x0.geolocation,
      _4870: x0 => x0.mediaDevices,
      _4872: x0 => x0.permissions,
      _4873: x0 => x0.maxTouchPoints,
      _4880: x0 => x0.appCodeName,
      _4881: x0 => x0.appName,
      _4882: x0 => x0.appVersion,
      _4883: x0 => x0.platform,
      _4884: x0 => x0.product,
      _4885: x0 => x0.productSub,
      _4886: x0 => x0.userAgent,
      _4887: x0 => x0.vendor,
      _4888: x0 => x0.vendorSub,
      _4890: x0 => x0.language,
      _4891: x0 => x0.languages,
      _4892: x0 => x0.onLine,
      _4897: x0 => x0.hardwareConcurrency,
      _4899: x0 => x0.storage,
      _4919: x0 => x0.width,
      _4920: x0 => x0.height,
      _4936: x0 => x0.data,
      ...
      _7036: x0 => x0.length,
      _7076: x0 => x0.baseURI,
      _7082: x0 => x0.firstChild,
      _7093: () => globalThis.document,
      _7173: x0 => x0.body,
      _7175: x0 => x0.head,
      _7504: (x0,x1) => { x0.id = x1 },
      _7531: x0 => x0.children,
      _8850: x0 => x0.value,
      _8852: x0 => x0.done,
      _9015: x0 => x0.size,
      _9016: x0 => x0.type,
      _9022: x0 => x0.name,
      _9023: x0 => x0.lastModified,
      _9028: x0 => x0.length,
      _9033: x0 => x0.result,
      _9529: x0 => x0.url,
      _9531: x0 => x0.status,
      _9533: x0 => x0.statusText,
      _9534: x0 => x0.headers,
      _9535: x0 => x0.body,
      _10983: x0 => x0.result,
      _10984: x0 => x0.error,
      _10995: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10997: x0 => x0.oldVersion,
      _11076: x0 => x0.key,
      _11077: x0 => x0.primaryKey,
      _11079: x0 => x0.value,
      _11537: (x0,x1) => { x0.alignItems = x1 },
      _11917: (x0,x1) => { x0.display = x1 },
      _12081: (x0,x1) => { x0.height = x1 },
      _12131: (x0,x1) => { x0.justifyContent = x1 },
      _12253: (x0,x1) => { x0.maxWidth = x1 },
      _12771: (x0,x1) => { x0.width = x1 },
      _13139: x0 => x0.name,
      _13140: x0 => x0.message,
      _13143: x0 => x0.subtle,
      _13847: () => globalThis.console,
      _13873: () => globalThis.speechSynthesis,
      _13874: (x0,x1) => { x0.lang = x1 },
      _13876: (x0,x1) => { x0.pitch = x1 },
      _13879: (x0,x1) => { x0.rate = x1 },
      _13881: (x0,x1) => { x0.text = x1 },
      _13882: (x0,x1) => { x0.voice = x1 },
      _13883: x0 => x0.voice,
      _13885: (x0,x1) => { x0.volume = x1 },
      _13886: (x0,x1) => { x0.onstart = x1 },
      _13887: (x0,x1) => { x0.onend = x1 },
      _13888: (x0,x1) => { x0.onpause = x1 },
      _13889: (x0,x1) => { x0.onresume = x1 },
      _13890: (x0,x1) => { x0.onerror = x1 },
      _13891: (x0,x1) => { x0.onboundary = x1 },
      _13893: x0 => x0.lang,
      _13894: x0 => x0.localService,
      _13895: x0 => x0.name,
